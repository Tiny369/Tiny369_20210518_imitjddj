...
<style lang="scss" scoped>
  ...
  .category {
    width: 76px;
    // background-color: rgb(215, 233, 215);
    overflow-y: scroll;
    // 每一分类项
    .category__item {
      height: 40px;
    ...
    .detail__item {
      ...
      .detail__content {
        ...
        .detailContent__PriceOrder {
          ...
          .detailContent__right {
            flex: 1;
            line-height: 20px;
            margin-left: 36px;
            display: flex;
            .detailContent__minus,.detailContent__add {
              width: 17px;
              height: 17px;
